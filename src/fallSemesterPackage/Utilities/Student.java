...
public class Student {
   ...
   //Construct and return a string representation of the student
	...
	public String validateData(){
		if (name.length() == 0){
			return "Error: You're missing a name \n";
		} 
		if (test1 < 0 | test1 > 100){
			return "Error: Your first test variable is invalid \n";
		}
		if (test2 < 0 | test2 > 100){
			return "Error: Your second test variable is invalid \n";
		}
		if (test3 < 0 | test3 > 100){
			return "Error: Your third test variable is invalid \n";
		} 
		if (name.length() != 0 && test1 > 0 || test1 < 100 && test2 > 0 || test2 < 100 && test3 > 0 || test3 < 100){
			return null;
		} else return "";
	}
}
